...
export class AddT5SectionSlug1749536602241 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`
            ...
            VALUES 
             ...
             (118,8, 'T5 Footer', 't5-footer'),
             (119,8, 'T5 Market Availability', 't5-market-availability'),
             (120,8, 'T5 Section Setting', 't5-section-setting')
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
     await queryRunner.query(`
            ...
            WHERE id IN (109,110,111,112,113,114,115,116,117,118,119,120);
        `);
    }
