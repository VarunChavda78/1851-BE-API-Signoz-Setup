import { MigrationInterface, QueryRunner,TableCheck,Table ,TableForeignKey} from "typeorm";

export class Landing21733998927093 implements MigrationInterface {
    name = 'Landing21733998927093'
